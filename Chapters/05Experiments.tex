...
\end{center}
This linear color transfer method can not giving satisfying results when content and style colors are too different. The color distribution may not be matched perfectly.
