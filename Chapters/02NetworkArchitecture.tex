...
\subsection{Pruning}
    ...
    in our schedule our shown in Figure \ref{fig:AGP}. 
        ...
        \begin{figure}[h!]
            ...
            \caption{Density of pruned layers after each epoch. \kamil{tutaj nie powinno byc na osi Y w legedzie ze x100? bo inaczej by wychodzilo ze z 1\% do 0.25\% sie zmniejsza }
            }
            \label{fig:AGP}
        \end{figure}
    ...
    change of weights. After 10 epochs, specified \kamil{brzmi jak gdyby brakowalo tu jakiegos slowa lub przecinka ale moze w sumie nie brakuje :D }
    ...
    \begin{center}
     \begin{figure}[h!]
            \includegraphics[scale=0.5]{wykresy.png}
