...
\subsection{Pruning}
    ...
    special VGG19 loss module. The network was pretrained on large dataset for classifiaction
    ...
    in instable training of transformation module and gradient explosion (see \ref{what_didnt_work}).
