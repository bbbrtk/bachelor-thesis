...
\subsection{References}\bibitem{lamport94}
...
If you are using this template in Norwegian do not touch the apanor.bst file. This contains the sourcecode for the Norwegian style citation and referencing with natbib. Automatically generated words like ''and'', ''page'' and ''in'' is changed to ''og'', ''side'' and ''i''.
