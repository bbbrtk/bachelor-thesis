...
\subsection{Mobile Application}
    ...
    \subsubsection{Description}
        ...
        quite similar to React "components". You use widgets to build whole UI 
        and some of them are:
        \begin{itemize}
            \item Layout widgets - e.g. rows, columns, lists, grids, tables
            \item Style widgets - e.g. colors
            \item Structure widgets - e.g. buttons
            \item Animation widgets - e.g. transition
        \end{itemize}
        Flutter comes with loads of prebuild Material Design widgets which makes 
        easy and fast to create applications in this particular great convention. 
