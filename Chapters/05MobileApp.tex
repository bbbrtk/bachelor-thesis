...
to hide list by clicking on down arrow icon (look at Figure \ref{fig:gallery_folded).
In right upper corner we can see settings icon. If we tap it box with 

\begin{figure}[H]
    \minipage{0.32\textwidth}
        \includegraphics[width=\linewidth]{gallery_1.jpg}
        \caption{A really Awesome Image}\label{fig:gallery_unfolded}
    \endminipage\hfill
    \minipage{0.32\textwidth}
        \includegraphics[width=\linewidth]{gallery_2.jpg}
        \caption{A really Awesome Image}\label{fig:gallery_folded}
    \endminipage\hfill
    \minipage{0.32\textwidth}
        \includegraphics[width=\linewidth]{options.jpg}
        \caption{A really Awesome Image}\label{fig:gallery_options}
    \endminipage\hfill
\end{figure}
