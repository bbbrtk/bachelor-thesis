...
\newpage
\textbf{todo package} \\
\url{https://github.com/henrikmidtiby/todonotes} \\
\textbf{todo commands} \\
\url{https://tex.stackexchange.com/a/178806} \\
\textbf{usage}
\TODO{\textbackslash TODO}
\kamil[inline] {\textbackslash kamil[inline]}
\filip[inline] {\textbackslash filip[inline]}
\bartek[inline] {\textbackslash bartek[inline]}
\asia[inline] {\textbackslash asia[inline]}
\listoftodos
% ----- end of todo new commands -----
...
\section{Network architecture}
    \subfile{Chapters/02aNetwork architecture}
\clearpage

\section{Related Work}
    \subfile{Chapters/03RelatedWork}
\clearpage
...
\section{Experiments}
    \subfile{Chapters/05Experiments}
\clearpage
